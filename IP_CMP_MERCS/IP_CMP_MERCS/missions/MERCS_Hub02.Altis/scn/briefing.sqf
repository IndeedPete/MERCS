...
switch (_mission) do {
	...
	case "MMain01": {
		[player, [("t" + _mission + "Insertion"), ("t" + _mission)], ["Report in with McMillian when you're ready to move out!", "Report in!", "McMillian"], IP_Commander, true, 1] call BIS_fnc_taskCreate;
	};
	...
	case "MMain04": {
		["MMain04", true, 5] call IP_fnc_endMission;
	};
