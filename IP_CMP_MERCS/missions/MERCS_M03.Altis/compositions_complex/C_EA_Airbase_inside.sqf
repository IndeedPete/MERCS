...
if (true) then
{
	_this = _group_2 createUnit ["I_Soldier_F", [14601.578, 16769.637, 4.9851465], [], 0, "CAN_COLLIDE"];
	_unit_10 = _this;
...
if (true) then
{
	_this = _group_2 createUnit ["I_Soldier_F", [14625.716, 16793.881, 5.10256], [], 0, "CAN_COLLIDE"];
	_unit_11 = _this;
...
if (true) then
{
	_this = _group_2 createUnit ["I_Soldier_lite_F", [14604.905, 16821.135, 0.085324116], [], 0, "CAN_COLLIDE"];
	_unit_34 = _this;
...
if (true) then
{
	_this = _group_2 createUnit ["I_Soldier_lite_F", [14574.618, 16792.732, 0.11780521], [], 0, "CAN_COLLIDE"];
	_unit_35 = _this;
...
if (true) then
{
	_this = _group_2 createUnit ["I_Soldier_F", [14632.8, 16790.367, 4.0261087], [], 0, "CAN_COLLIDE"];
	_unit_47 = _this;
...
if (true) then
{
	_this = _group_2 createUnit ["I_Soldier_F", [14599.737, 16786.004, 0.089986317], [], 0, "CAN_COLLIDE"];
	_unit_50 = _this;
...
if (true) then
{
	_this = _group_2 createUnit ["I_G_Soldier_F", [14617.516, 16803.471, 0.082785465], [], 0, "CAN_COLLIDE"];
	_unit_56 = _this;
	_this setPos [14617.516, 16803.471, 0.082785465];
	_this setDir -52.09103;
	_this setUnitAbility 0.60000002;
	if (false) then {_group_2 selectLeader _this;};
	_initCodes set [count _initCodes,[_this,"[this,""LEAN"",""ASIS""] call BIS_fnc_ambientAnim; removeAllWeapons this; removeUniform this; removeVest this; removeHeadgear this; this addVest ""V_TacVest_oli""; {this addMagazine ""30Rnd_65x39_caseless_mag""} forEach [0,1,2,3,4,5]; this addWeapon ""arifle_MXC_Black_F""; this addPrimaryWeaponItem ""optic_aco""; this forceAddUniform ""U_BG_Guerilla2_3""; this addHeadgear ""H_Cap_blk_ION""; this addGoggles ""G_Squares"";   "]];
};

_unit_57 = objNull;
if (true) then
{
	_this = _group_2 createUnit ["I_G_Soldier_F", [14617.242, 16807.682, 0.067652166], [], 0, "CAN_COLLIDE"];
	_unit_57 = _this;
	_this setPos [14617.242, 16807.682, 0.067652166];
	_this setDir -49.61079;
	_this setUnitAbility 0.60000002;
	if (false) then {_group_2 selectLeader _this;};
	_initCodes set [count _initCodes,[_this,"[this,""WATCH2"",""ASIS""] call BIS_fnc_ambientAnim; removeAllWeapons this; removeUniform this; removeVest this; removeHeadgear this; this addVest ""V_TacVest_oli""; {this addMagazine ""30Rnd_9x21_Mag""} forEach [0,1,2,3,4,5]; this addWeapon ""SMG_02_ACO_F""; this forceAddUniform ""U_BG_Guerilla2_2""; this addHeadgear ""H_BandMask_blk""; this addGoggles ""G_Shades_Red"";"]];
};

_unit_59 = objNull;
if (true) then
{
	_this = _group_2 createUnit ["I_G_Soldier_F", [14584.463, 16778.387, 0.15755729], [], 0, "CAN_COLLIDE"];
	_unit_59 = _this;
	_this setPos [14584.463, 16778.387, 0.15755729];
	_this setDir 47.092731;
	_this setUnitAbility 0.60000002;
	if (false) then {_group_2 selectLeader _this;};
	_initCodes set [count _initCodes,[_this,"[this,""WATCH2"",""ASIS""] call BIS_fnc_ambientAnim; removeAllWeapons this; removeUniform this; removeVest this; removeHeadgear this; this addVest ""V_TacVest_oli""; {this addMagazine ""30Rnd_65x39_caseless_mag""} forEach [0,1,2,3,4,5]; this addWeapon ""arifle_MX_Black_F""; this addPrimaryWeaponItem ""optic_HAMR""; this forceAddUniform ""U_BG_Guerilla2_1""; this addHeadgear ""H_Cap_blk_ION""; this addGoggles ""G_Squares"";   "]];
};

_unit_62 = objNull;
if (true) then
{
	_this = _group_2 createUnit ["I_G_Soldier_F", [14585.671, 16779.391, 0.1123741], [], 0, "CAN_COLLIDE"];
	_unit_62 = _this;
	_this setPos [14585.671, 16779.391, 0.1123741];
	_this setDir -139.23238;
	_this setUnitAbility 0.60000002;
	if (false) then {_group_2 selectLeader _this;};
	_initCodes set [count _initCodes,[_this,"[this,""WATCH1"",""ASIS""] call BIS_fnc_ambientAnim; removeAllWeapons this; removeUniform this; removeVest this; removeHeadgear this; this addVest ""V_TacVest_oli""; {this addMagazine ""30Rnd_9x21_Mag""} forEach [0,1,2,3,4,5]; this addWeapon ""SMG_02_ACO_F""; this forceAddUniform ""U_BG_Guerilla2_3""; this addHeadgear ""H_Cap_blk_ION""; this addGoggles ""G_Shades_Red"";"]];
};
...
if (true) then
{
	_this = _group_2 createUnit ["I_soldier_AR_F", [14629.338, 16787.309, 0.065680355], [], 0, "CAN_COLLIDE"];
	_unit_68 = _this;
...
if (true) then
{
	_this = _group_2 createUnit ["I_Soldier_GL_F", [14608.542, 16766.799, 0.086178206], [], 0, "CAN_COLLIDE"];
	_unit_70 = _this;
