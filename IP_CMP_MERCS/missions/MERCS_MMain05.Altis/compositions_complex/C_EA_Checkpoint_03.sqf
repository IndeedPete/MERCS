...
if (true) then
{
	_this = createVehicle ["I_HMG_01_high_F", [15118.831, 17505.416, 0.00020122528], [], 0, "CAN_COLLIDE"];
	_vehicle_16 = _this;
...
if (true) then
{
	_this = createVehicle ["I_MBT_03_cannon_F", [15212.066, 17560.473, 0.097512946], [], 0, "CAN_COLLIDE"];
	_vehicle_40 = _this;
...
if (true) then
{
	_this = _group_1 createUnit ["I_Soldier_GL_F", [15104.231, 17523.973, -4.7683716e-006], [], 0, "NONE"];
	_unit_2 = _this;
	_this setPos [15104.231, 17523.973, -4.7683716e-006];
	_this setDir -155.82109;
	_this setUnitAbility 0.60000002;
	if (true) then {_group_1 selectLeader _this;};
	_initCodes set [count _initCodes,[_this,"[this,""WATCH2"",""ASIS""] call BIS_fnc_ambientAnimCombat;"]];
};

_unit_3 = objNull;
if (true) then
{
	_this = _group_1 createUnit ["I_soldier_AR_F", [15101.857, 17526.135, -3.7193298e-005], [], 0, "CAN_COLLIDE"];
	_unit_3 = _this;
	_this setPos [15101.857, 17526.135, -3.7193298e-005];
	_this setDir -115.30196;
	_this setUnitAbility 0.60000002;
	if (false) then {_group_1 selectLeader _this;};
	_initCodes set [count _initCodes,[_this,"[this,""STAND"",""ASIS""] call BIS_fnc_ambientAnimCombat;"]];
};

_unit_6 = objNull;
if (true) then
{
	_this = _group_1 createUnit ["I_Soldier_lite_F", [15120.587, 17504.781, 5.9127808e-005], [], 0, "CAN_COLLIDE"];
	_unit_6 = _this;
...
if (true) then
{
	_this = _group_1 createUnit ["I_crew_F", [15210.902, 17558.203, -4.0054321e-005], [], 0, "CAN_COLLIDE"];
	_unit_7 = _this;
...
if (true) then
{
	_this = _group_1 createUnit ["I_Soldier_F", [15215.821, 17538.299, 1.9073486e-006], [], 0, "CAN_COLLIDE"];
	_unit_8 = _this;
...
if (true) then
{
	_this = _group_1 createUnit ["I_soldier_LAT_F", [15215.441, 17541.811, -2.4795532e-005], [], 0, "CAN_COLLIDE"];
	_unit_10 = _this;
	_this setPos [15215.441, 17541.811, -2.4795532e-005];
	_this setDir 26.387577;
	_this setUnitAbility 0.60000002;
	if (false) then {_group_1 selectLeader _this;};
	_initCodes set [count _initCodes,[_this,"[this,""WATCH1"",""ASIS""] call BIS_fnc_ambientAnimCombat;"]];
};

_unit_14 = objNull;
if (true) then
{
	_this = _group_1 createUnit ["I_Soldier_F", [15124.279, 17543.459, -0.011470501], [], 0, "NONE"];
	_unit_14 = _this;
...
if (true) then
{
	_this = _group_1 createUnit ["I_soldier_M_F", [15124.472, 17541.305, -4.2915344e-005], [], 0, "NONE"];
	_unit_15 = _this;
...
if (true) then
{
	_this = _group_1 createUnit ["I_Soldier_GL_F", [15101.528, 17590.738, 2.7656555e-005], [], 0, "NONE"];
	_unit_17 = _this;
...
if (true) then
{
	_this = _group_1 createUnit ["I_soldier_AR_F", [15072.25, 17601.742, -4.9591064e-005], [], 0, "CAN_COLLIDE"];
	_unit_19 = _this;
