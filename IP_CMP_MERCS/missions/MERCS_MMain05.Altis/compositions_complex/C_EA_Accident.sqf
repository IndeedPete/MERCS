...
if (true) then
{
	_this = _group_1 createUnit ["I_medic_F", [14386.505, 17982.283, -1.9073486e-006], [], 0, "CAN_COLLIDE"];
	_unit_1 = _this;
...
if (true) then
{
	_this = _group_1 createUnit ["I_Soldier_F", [14398.185, 17967.336, 7.8201294e-005], [], 0, "CAN_COLLIDE"];
	_unit_3 = _this;
